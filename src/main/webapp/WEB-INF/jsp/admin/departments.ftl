            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="/admin/upload">
                                <i class="fa fa-dashboard"></i> <span>Upload Data</span>
                            </a>                            
                        </li>                                             
                    </ul>
                </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="/admin/departments" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="/admin/questions" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                                    ...
                                    <ul class="todo-list">
                                      <#list departments as department>
                                        <li>
                                            ...
                                            <!-- todo text -->
                                            <span class="text">${department.id}</span>
                                            <span class="text" style="margin-left: 20px;">${department.name}</span>
                                            <span class="text" style="margin-left: 20px;">${department.discription}</span>                                            
                                            <!-- General tools such as edit or delete-->
                                            <div class="tools">                                                
                                                <a href="/admin/delete-department?id=${department.id}"><i class="fa fa-trash-o"></i></a>
                                            </div>
                                        </li>     
                                        </#list>                                  
                                    </ul>
